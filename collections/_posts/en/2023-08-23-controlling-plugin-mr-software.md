...
But if, there is Kimai mobile for [iOS]({% link _store/{{ page.lang }}/cloudrizon-kimai-mobile-app-ios.md %}) and [Android]({% link _store/{{ page.lang }}/cloudrizon-kimai-mobile-app-android.md %}y) as replacement.
