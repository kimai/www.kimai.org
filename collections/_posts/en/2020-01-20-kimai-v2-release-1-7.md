...
- the [Console client (PHAR)]({% link _store/{{ page.lang }}/keleo-console-phar.md %})
- the [Easy backup]({% link _store/{{ page.lang }}/maximiliangross-easy-backup-bundle.md %})

**ATTENTION: Users of the [ExpenseBundle]({%link _store/{{ page.lang }}/keleo-expenses-bundle.md %}) have to delete it before they upgrade to 1.7, 
