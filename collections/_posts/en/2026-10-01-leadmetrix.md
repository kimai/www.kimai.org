...
quote: "Gil Ben-Horin is a developer-turned-entrepreneur with a background in computational linguistics and an MBA. He led the company from a solo web development practice into a thriving RevOps boutique, growing organically by prioritizing outcomes over processes."
quote2: "Clients love the transparency. They used to just get an invoice at month end and ask questions if the hours looked unfair. Now they see exactly what was done."
position: Founder
industry: B2B RevOps
size: 10+
since: 2024
...
version: onpremise
wins:
    - Saved time on manual report generation with a custom-developed plugin
    - Earlier visibility into project profitability with weekly tracking
    - Optimized billable vs. non-billable ratio to cut down internal costs
    - Reduced client invoice disputes through transparent, detailed PDF reports
    - Saved time on work administration by using weekly hours view
---
 
**TL;DR**  

A boutique RevOps agency from Israel has relied on Kimai for years to ensure transparent, hour-by-hour billing and build trust with their clients. When they recognized the potential of Kimai's reporting capabilities, they took it a step further and developed a custom reporting plugin — now available in the Kimai plugin store.
...
**The workflow: a calendar view the whole team uses**

The team quickly got used to Kimai's [calendar view]({% link _documentation/calendar.md %}). Team members open the week, drag a time block – say, 9:00 to 11:00 on Monday – type a description, and click. Frequently used tasks sit in a sidebar and can be dragged straight into the calendar. *"It's genuinely satisfying to see a full week of time logged,"* Gil says. Different people log differently, some in real time, some after finishing a task, some in batches at the end of the day. Kimai accommodates all of these without forcing a single habit. The head of operations starts every morning by opening Kimai and scanning the week view per employee: how much time was worked, how much was billed.
...
*"Clients love the transparency,"* Gil says. *"They used to just get an invoice at month end and ask questions if the hours looked unfair. Now they see exactly what was done."* That visibility occasionally prompts pushback, when clients question whether a task really took as long as logged, but Gil prefers that conversation to the alternative. An invoice without a paper trail is a harder argument to win than a clearly structured report.

<!-- PARTS -->

**Looking ahead: integrations and the AI pressure**
