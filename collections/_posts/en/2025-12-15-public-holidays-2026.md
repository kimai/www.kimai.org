...
<strong>Public Holidays Germany 2026 (9–13 depending on state)</strong>
...
- Public holidays vary widely by Bundesland (federal state):
...
1. List all employee locations (country + region)
2. Gather all 2026 public holidays
3. Ensure your time management system supports regional holiday calendars
4. Test how holidays affect balances and overtime
5. Verify payroll integrations
6. Review absence types
7. Confirm GDPR/DSGVO compliance
...
The [Working Contract Plugin]({% link _store/keleo-controlling.md %}) is one of the simplest solutions.

Watch this short video tutorial to learn how to check the list of public holidays for the next year:

{% include youtube-video.html id="import_public_holidays" %}
...
Try it now in the [Kimai Demo]({% link _pages/demo.md %}),  
set it up in your {% include link-cloud-start.html title="Kimai Cloud" %},  
or learn more on the [Working Contract Plugin]({% link _store/keleo-controlling.md %}) page.
