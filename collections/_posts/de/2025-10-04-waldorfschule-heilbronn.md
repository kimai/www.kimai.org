...
„Er hat kleine Holzkästchen genommen, einen Raspberry Pi und einen Touchscreen eingebaut – jetzt läuft Kimai im [Kiosk-Modus]({% link _store/{{ page.lang }}/kiosk-barcode-bundle.md %})*", erklärt Jörg Hartmann.
