...
quote: "Jan Krempchen founded his company in 2015 while studying at the Cologne University of Applied Sciences. Initially, it provided services to private customers, and later became an IT service provider for small and medium-sized businesses in Cologne that do not have their own IT departments."
quote2: "Before Kimai, we spent an entire workday each month manually entering work hours into our accounting software. Today, it takes us less than half a day—even though we have many more entries."
position: Founder
...
version: onpremise
wins:
    - Over 50% time savings on monthly billing
    - Significantly fewer errors thanks to automated data transfer
    - Seamless one-click integration with the open-source ticket system Zammad
    - Reliable updates without downtime
    - Scalability without additional administrative overhead
---

**TL;DR**

The IT service provider TECH-SUPPORT.KOELN has fully integrated Kimai into all of its business processes — from automatic time tracking to seamless invoicing and accounting.  
This helps the company reduce errors and focus on strategic tasks.

**About the company**

TECH-SUPPORT.KOELN is a local IT service provider based in Cologne, specializing in supporting law firms without their own IT department.  
The company assists its customers with selecting, installing, and maintaining a tailored IT infrastructure, either on-premises or in its own high-availability cloud, including PC, laptop, and server repairs as well as the administration of Windows and Linux systems.  
The company is a member of the Alliance for Cyber Security Germany and has made it its mission to implement high IT security standards for its customers.
...
What sounds like a small technical detail revolutionized everyday work at TECH-SUPPORT.KOELN. No more manual data entry, no more forgotten entries, no more wasted time switching between systems.

For new customers, Jan follows a fixed checklist: first, he creates the customer in Kimai, then the agreed hourly rates, and finally the projects and services for later billing.  
This keeps his time-tracking system consistent and error-free.

In addition to the existing functionality, Jan purchased Kimai plugins for expenses and custom fields. This allows him to record expenses such as goods with serial numbers and document which supplier they came from.
...
**Measurable results: more than just time savings**
...
With the right software, it becomes a strategic tool that optimizes processes, minimizes errors, and frees up valuable resources.

Jan Krempchen has found a solution that grows with his business — without administrative effort escalating at the same pace.  
That is the true value of Kimai: not just tracking time, but creating time.

Many thanks to Jan Krempchen for the interview, and best of luck with TECH-SUPPORT.KOELN!
