...
There is no automatism that will add a monthly budget to your invoice (you have to create [expenses]({% link _store/{{ page.lang }}/expenses-bundle.md %}) or time records for that).
