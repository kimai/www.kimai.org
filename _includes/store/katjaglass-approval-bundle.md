...
- [Lockdown per user settings]({% link _store/{{ page.lang }}/keleo-lockdown-per-user-bundle.md %}) (recommended)
- [Custom-fields plugin]({% link _store/{{ page.lang }}/keleo-custom-fields-bundle.md %}) (only required when using Kimai 1.x)
