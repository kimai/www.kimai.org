...
#### Cloud {% if page.lang == 'de' %}Eigentümer{% else %}owner{% endif %}

**Stripe**: Payment and Invoices, [Link](https://stripe.com), [Privacy policy](https://stripe.com/ie/legal/dpa)  
...
#### OnPremise {% if page.lang == 'de' %}Kunden{% else %}customers{% endif %}
